    ...
    <section class="why-us section-bg" data-aos="fade-up" date-aos-delay="200" style="background: white">
        <div class="container">
            ...
            <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
                <div class="carousel-inner" role="listbox">
                    <div class="carousel-item active">
                        <img class="d-block img-fluid" src="assets/img/club/SlideIMG/KOPAI.jpg" alt="First slide">
                    </div>
                    <div class="carousel-item">
                        <img class="d-block img-fluid" src="assets/img/club/SlideIMG/ALASAN.jpg" alt="Second slide">
                    </div>
                    <div class="carousel-item">
                        <img class="d-block img-fluid" src="assets/img/club/SlideIMG/2kopai.jpg" alt="Second slide">
                    </div>
                    <div class="carousel-item">
                        <img class="d-block img-fluid" src="assets/img/club/SlideIMG/1kopai.jpg" alt="Second slide">
                    </div>
                    <div class="carousel-item">
                        <img class="d-block img-fluid" src="assets/img/club/SlideIMG/3kopai.jpg" alt="Second slide">
                    </div>
                </div>
            </div>
            ...
            <p style="margin-top: 50px">
               <h4> Kopai (Komunitas Pencinta Alam IKAITL Trisakti)</h4>
                Komunitas unit ini tentunya memberikan juga peluang-peluang besar bagi yang hobby dan gemar akan kecintaannya dengan alam yang mana bagi alumni IKAITL Trisakti bisa mengikuti kegiatan-kegiatan pecinta alam serta juga memberikan dan share pengalaman bagi junior-junior para mahasiswa di ITL Trisakti dalam hal kegiatan pecinta alam tersebut.            
            </p>
        </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <div class="row">
                    <?php
                    $sqlIklan = mysqli_query($konek, "SELECT * FROM iklan WHERE Penempatan_Iklan = 'Iklan K Kopai 1'");
                    ...
                    <?php
                    $sqlIklan = mysqli_query($konek, "SELECT * FROM iklan WHERE Penempatan_Iklan = 'Iklan K Kopai 2'");
                    while($dataIklan = mysqli_fetch_array($sqlIklan)) {
                    ?>
                        <div class="col-lg-6 video-box">
                            <img src="admin/img/Iklan/<?= $dataIklan['gambar']?>" class="img-fluid" alt="" style="height: 300px; width: 100%">
                ...
                <div class="col-lg-12">
                    <form action="" method="post" role="form">
                        ...
                        <div class="form-row">
                            <div class="col-md-12 form-group">
                                <input type="hidden" name="nama_komunitas" value="KOPAI" class="form-control" id="alamat" />
                                <div class="validate"></div>
                            </div>
                        </div>
                        <div class="form-row">
                    ...
                    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
                        ...
                        if ($simpan) {
                            ...
                            echo "<script>document.location.href = 'k_kopai.php'; </script>";
                        } else {
