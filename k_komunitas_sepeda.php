    ...
    <section class="why-us section-bg" data-aos="fade-up" date-aos-delay="200" style="background: white">
        <div class="container">
            ...
            <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
                <div class="carousel-inner" role="listbox">
                    <div class="carousel-item active">
                        <img class="d-block img-fluid" src="assets/img/club/SlideIMG/SEPEDA 3.jpg" alt="First slide">
                    </div>
            ...
            <p style="margin-top: 50px">
                <h4>Komunitas Sepeda</h4>
                Komunitas unit dari ikaitl trisakti ini, dimana komunitas teresalurkan hobby nya yang tidak hanya menjadi 
                “demam” saja atau yang sedang trendy saja, namun komunitas unit ini khususnya bersepeda selalu berkesinambungan dan 
                terus-menerus yang mana bisa menjadi otomatis habit atau kebiasaan yang positif dengan sama-sama exis, baik ikaitl trisakti dan lembaga itl trisakti
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <div class="row">
                    <?php
                    $sqlIklan = mysqli_query($konek, "SELECT * FROM iklan WHERE Penempatan_Iklan = 'Iklan K Sepeda 1'");
                    ...
                    <?php
                    $sqlIklan = mysqli_query($konek, "SELECT * FROM iklan WHERE Penempatan_Iklan = 'Iklan K Sepeda 2'");
                    while($dataIklan = mysqli_fetch_array($sqlIklan)) {
                    ?>
                        <div class="col-lg-6 video-box">
                            <img src="admin/img/Iklan/<?= $dataIklan['gambar']?>" class="img-fluid" alt="" style="height: 300px; width: 100%">
                    ...
                    <form action="" method="post" role="form">
                        ...
                        <div class="form-row">
                            <div class="col-md-12 form-group">
                                <input type="hidden" name="nama_komunitas" value="Komunitas Sepeda" class="form-control" id="alamat" />
                                <div class="validate"></div>
                            </div>
                        </div>
                        <div class="form-row">
