    ...
    <section class="why-us section-bg" data-aos="fade-up" date-aos-delay="200" style="background: white">
        <div class="container">
            ...
            <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
                <div class="carousel-inner" role="listbox">
                    <div class="carousel-item active">
                        <img class="d-block img-fluid" src="assets/img/club/SlideIMG/LITBANG-TRISAKTI-11.jpg" alt="First slide">
                    </div>
            ...
            <p style="margin-top: 50px">
                <h4>Komunitas Penelitian dan Pengembangan IKAITL Trisakti</h4>
                Komunitas unit ini memberikan kesempatan dan peluang besar bagi IKAITL sebagai homebase Penelitian dan Pengembangan yang keilmuan, wawasan, ide, kreativitas dan pengalamannya bisa tersalurkan kedalam bentuk tulisan yang mana dengan independensi IKAITL Trisakti mempunyai wadah berupa Jurnal atau buku atau redaksi sendiri untuk majalah khusus translog serta khususnya bagi IKAITL Trisakti.
            </p>
        </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <div class="row">
                    <?php
                    $sqlIklan = mysqli_query($konek, "SELECT * FROM iklan WHERE Penempatan_Iklan = 'Iklan K Litbang 1'");
                    ...
                    <?php
                    $sqlIklan = mysqli_query($konek, "SELECT * FROM iklan WHERE Penempatan_Iklan = 'Iklan K Litbang 2'");
                    while($dataIklan = mysqli_fetch_array($sqlIklan)) {
                    ?>
                        <div class="col-lg-6 video-box">
                            <img src="admin/img/Iklan/<?= $dataIklan['gambar']?>" class="img-fluid" alt="" style="height: 300px; width: 100%">
                ...
                <div class="col-lg-12">
                    <form action="" method="post" role="form">
                        ...
                        <div class="form-row">
                            <div class="col-md-12 form-group">
                                <input type="hidden" name="nama_komunitas" value="Komunitas Litbang" class="form-control" id="alamat" />
                                <div class="validate"></div>
                            </div>
                        </div>
                        <div class="form-row">
                    ...
                    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
                        ...
                        if ($simpan) {
                            ...
                            echo "<script>document.location.href = 'k_komunitas_litbang.php'; </script>";
                        } else {
