    ...
    <section class="why-us section-bg" data-aos="fade-up" date-aos-delay="200" style="background: white">
        <div class="container">
            ...
            <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
                <div class="carousel-inner" role="listbox">
                    <div class="carousel-item active">
                        <img class="d-block img-fluid" src="assets/img/club/SlideIMG/SENI 2.jpg" alt="First slide">
                    </div>
            ...
            <p style="margin-top: 50px">
                <h4>Komunitas Seni</h4>
                Komunitas unit dari ikaitl trisakti mendukung penuh seni, adat dan budaya-budaya Indonesia yang dikolaborasikan dengan karya seni modern dan milenial dengan segala usia yang cinta seni dan budaya nasional, dengan bisa mengkontribusikan melalui hasil kreativitas seni berupa tarian yang dikombinasikan dengan tarian modern, budaya-budaya indonesia yang bisa di milenialkan juga pembuatan karya kreativitas melalui pembuatan film nasional dengan konsep cerita modern dan milenial yang kesemua unit semi ini adalah bentuk komersial baik dari ikaitl trisakti dan lembaga ititrisakti yang berkolaborasi dan saling support serta selalu bersilahturahmi yang berksinambungan.
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <div class="row">
                    <?php
                    $sqlIklan = mysqli_query($konek, "SELECT * FROM iklan WHERE Penempatan_Iklan = 'Iklan K Seni 1'");
                    ...
                    <?php } ?>
                    <?php
                    $sqlIklan = mysqli_query($konek, "SELECT * FROM iklan WHERE Penempatan_Iklan = 'Iklan K Seni 2'");
                    while($dataIklan = mysqli_fetch_array($sqlIklan)) {
                    ?>
                    ...
                    <form action="" method="post" role="form">
                        ...
                        <div class="form-row">
                            <div class="col-md-12 form-group">
                                <input type="hidden" name="nama_komunitas" value="Komunitas Seni" class="form-control" id="alamat" />
                                <div class="validate"></div>
                            </div>
                        </div>
                        <div class="form-row">
