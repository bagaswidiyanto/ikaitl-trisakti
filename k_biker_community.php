    ...
    <section class="breadcrumbs">
        <div class="container">
            ...
            <div class="d-flex justify-content-between align-items-center">
                <h2>Biker Community</h2>
                <ol>
                    <li><a href="index.html">Home</a></li>
                    <li>Biker Community</li>
                </ol>
            </div>
    ...
    <section class="why-us section-bg" data-aos="fade-up" date-aos-delay="200" style="background: white">
        <div class="container">
            ...
            <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
                <div class="carousel-inner" role="listbox">
                    <div class="carousel-item active">
                        <img class="d-block img-fluid" src="assets/img/club/SlideIMG/BROTHERHOOD 2.jpg" alt="First slide">
                    </div>
                    <div class="carousel-item">
                        <img class="d-block img-fluid" src="assets/img/club/SlideIMG/ALASAN.jpg" alt="Second slide">
                    </div>
                     <div class="carousel-item">
                        <img class="d-block img-fluid" src="assets/img/club/SlideIMG/3motor.jpg" alt="Second slide">
                    </div>
                    <div class="carousel-item">
                        <img class="d-block img-fluid" src="assets/img/club/SlideIMG/2motor.jpg" alt="Second slide">
                    </div>
                    <div class="carousel-item">
                        <img class="d-block img-fluid" src="assets/img/club/SlideIMG/1motor.jpg" alt="Second slide">
                    </div>
                </div>
            </div>
            ...
            <p style="margin-top: 50px">
                <h4>Komunitas Motorcycle</h4>
                Komunitas unit ini membawa citra baik yang berkesinambungan melalui hobby motor dengan melakukan bakti sosial baik acara hari raya-hari raya semua agama dengan menyalurkan melalui panti asuhan-panti asuhan dengan kegiatan safety riding untuk berlalu lintas yang ramah dan santun.
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <div class="row">
                    <?php
                    $sqlIklan = mysqli_query($konek, "SELECT * FROM iklan WHERE Penempatan_Iklan = 'Iklan K Biker 1'");
                    ...
                    <?php
                    $sqlIklan = mysqli_query($konek, "SELECT * FROM iklan WHERE Penempatan_Iklan = 'Iklan K Biker 2'");
                    while($dataIklan = mysqli_fetch_array($sqlIklan)) {
                    ?>
                        <div class="col-lg-6 video-box">
                            <img src="admin/img/Iklan/<?= $dataIklan['gambar']?>" class="img-fluid" alt="" style="height: 300px; width: 100%">
                    ...
                    <form action="" method="post" role="form">
                        ...
                        <div class="form-row">
                            <div class="col-md-12 form-group">
                                <input type="hidden" name="nama_komunitas" value="Biker Community" class="form-control" id="alamat" />
                                <div class="validate"></div>
                            </div>
                        </div>
                        <div class="form-row">
                        ...
                        <div class="text-center"><button type="submit" class="btn btn-primary mr-2">Submit</button></div>
                    </form>
                    <?php
