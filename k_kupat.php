    ...
    <section class="why-us section-bg" data-aos="fade-up" date-aos-delay="200" style="background: white">
        <div class="container">
            ...
            <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
                <div class="carousel-inner" role="listbox">
                    <div class="carousel-item active">
                        <img class="d-block img-fluid" src="assets/img/club/SlideIMG/KUPAT.jpg" alt="First slide">
                    </div>
                    <div class="carousel-item">
                        <img class="d-block img-fluid" src="assets/img/club/SlideIMG/ALASAN.jpg" alt="Second slide">
                    </div>
                    <div class="carousel-item">
                        <img class="d-block img-fluid" src="assets/img/club/SlideIMG/1sikams.jpg" alt="Second slide">
                    </div>
                </div>
            </div>
            ...
            <p style="margin-top: 50px">
                <h4>Komunitas Kupat (Kulineran, UKM dan Pariwisata)</h4>
                Komunitas unit ini sangat memberikan peluang besar bagi UKM yang bergerak di bidang bisnis kuliner dan pariwisata yang mana juga mendukung kegiatan translog (transportasi dan logistik) agar para usahawan UKM dan Pariwisata tetap bergairah dan ini juga membuka peluang besar bagi alumni ITL Trisakti dan alumni kampus lainnya untuk bersinergi dan berkolaborasi serta meningkatkan silahturahmi yang erat kepada sesama alumni ITL Trisakti itu sendiri dan alumni-alumnni perguruan tinggi lainnya.
            </p>
        </div>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="row">
                    <?php
                    $sqlIklan = mysqli_query($konek, "SELECT * FROM iklan WHERE Penempatan_Iklan = 'Iklan K Kupat 1'");
                    ...
                    <?php
                    $sqlIklan = mysqli_query($konek, "SELECT * FROM iklan WHERE Penempatan_Iklan = 'Iklan K Kupat 2'");
                    while($dataIklan = mysqli_fetch_array($sqlIklan)) {
                    ?>
                        <div class="col-lg-6 video-box">
                            <img src="admin/img/Iklan/<?= $dataIklan['gambar']?>" class="img-fluid" alt="" style="height: 300px; width: 100%">
                    ...
                    <form action="" method="post" role="form">
                        ...
                        <div class="form-row">
                            <div class="col-md-12 form-group">
                                <input type="hidden" name="nama_komunitas" value="KUPAT" class="form-control" id="alamat" />
                                <div class="validate"></div>
                            </div>
                        </div>
                        <div class="form-row">
