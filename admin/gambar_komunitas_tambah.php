                        ...
                        <form method="post" enctype="multipart/form-data">
                            ...
                            if ($_SERVER['REQUEST_METHOD'] == 'POST') {
                                ...
                                if ($namaKomunitas == '') {
                                    ...
                                    $simpan = mysqli_query(
                                        $konek,
                                        "INSERT INTO gambar_komunitas (`Nama_Komunitas`, `Link`, `Tanggal`, `gambar`) 
                                        VALUES ('$namaKomunitas', '$link', '$tanggal', '$gambar')"
                                    );

                                    if ($simpan) {
                                        echo "<script>document.location.href = 'gambar_komunitas.php';</script>";
                                    }
                                }
                            }
                            ?>
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="Nama_Komunitas" id="" placeholder="Nama Komunitas" required>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="" class="col-sm-2 col-form-label">Link</label>
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="Link" id="" placeholder="Link Komunitas" required>
                                </div>
                            </div>
                            <div class="form-group row">
                            ...
                            <button class="btn btn-light"><a href="gambar_komunitas.php">Cancel</a></button>
                        </form>
                    </div>
                </div>
            </div>
