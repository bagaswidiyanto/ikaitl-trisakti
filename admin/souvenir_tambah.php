                    ...
                    <div class="card-body">
                        <form method="post" enctype="multipart/form-data">
                            ...
                            if ($_SERVER['REQUEST_METHOD'] == 'POST') {
                                ...
                                $simpan = mysqli_query(
                                    $konek,
                                    "INSERT INTO souvenir (`Nama_Barang`, `Harga`, `No_Telp`, `gambar`) 
                                        VALUES ('$namaBarang' ,'$harga', '$noTelp', '$gambar')"
                                );
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="Nama_Barang" id="" placeholder="Nama Produk" required>
                                </div>
                            </div>
                            <div class="form-group row">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" value="08988153992" class="form-control" name="No_Telp" readonly>
                                </div>
                            </div>
                            <div class="form-group row">
                            ...
                            <button class="btn btn-light"><a href="souvenir.php">Cancel</a></button>
                        </form>
                    </div>
                </div>
            </div>
