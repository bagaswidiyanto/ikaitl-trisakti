    ...
    <section class="why-us section-bg" data-aos="fade-up" date-aos-delay="200" style="background: white">
        <div class="container">
            ...
            <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
                <div class="carousel-inner" role="listbox">
                    <div class="carousel-item active">
                        <img class="d-block img-fluid" src="assets/img/club/SlideIMG/BASKET 2.jpg" alt="First slide">
                    </div>
                    <div class="carousel-item">
                        <img class="d-block img-fluid" src="assets/img/club/SlideIMG/ALASAN.jpg" alt="Second slide">
                    </div>
                     <div class="carousel-item">
                        <img class="d-block img-fluid" src="assets/img/club/SlideIMG/1basket.jpg" alt="Second slide">
                    </div>
                     <div class="carousel-item">
                        <img class="d-block img-fluid" src="assets/img/club/SlideIMG/2basket.jpg" alt="Second slide">
                    </div>
                     <div class="carousel-item">
                        <img class="d-block img-fluid" src="assets/img/club/SlideIMG/3basket.jpg" alt="Second slide">
                    </div>
                </div>
            </div>
            ...
            <p style="margin-top: 50px">
                <h4>Komunitas Basket</h4>
                Komunitas unit ikaitl trisakti ini, bisa menyambung silahturahmi baik antar alumni ikaitl trisakti, antar alumni kampus-kampus di DKI dan secara nasional maupun silahturahmi yang kuat dengan lembaga itl trisakti untuk saling support dengan mengadakan kompetisi-kompetisi basket dan pertandingan yang sehat antar alumni ikaitl trisakti dan lembaga itl trisakti secara sehat.
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <div class="row">
                    <?php
                    $sqlIklan = mysqli_query($konek, "SELECT * FROM iklan WHERE Penempatan_Iklan = 'Iklan K Basket 1'");
                    ...
                    <?php
                    $sqlIklan = mysqli_query($konek, "SELECT * FROM iklan WHERE Penempatan_Iklan = 'Iklan K Basket 2'");
                    while($dataIklan = mysqli_fetch_array($sqlIklan)) {
                    ?>
                        <div class="col-lg-6 video-box">
                            <img src="admin/img/Iklan/<?= $dataIklan['gambar']?>" class="img-fluid" alt="" style="height: 300px; width: 100%">
                    ...
                    <form action="" method="post" role="form">
                        ...
                        <div class="form-row">
                            <div class="col-md-12 form-group">
                                <input type="hidden" name="nama_komunitas" value="Komunitas Basket" class="form-control" id="alamat" />
                                <div class="validate"></div>
                            </div>
                        </div>
                        <div class="form-row">
